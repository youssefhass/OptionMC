...
public class StudentProfile implements Serializable {
	...
	private Set<Module> selectedReserveModules;
	...
	public StudentProfile() {
		...
		selectedReserveModules = new TreeSet<Module>();
	}
	...
	public boolean addSelectedReserveModule(Module m) {
		return selectedReserveModules.add(m);
	}
	
	public Set<Module> getSelectedReserveModules() {
		return selectedReserveModules;
	}
	
	public void clearSelectedReserveModules() {
		selectedReserveModules.clear();
	}
	...
	public String toString() {
		return "StudentProfile:[pNumber=" + pNumber + ", studentName="
				...
				+ ",selectedReserveModules=" + selectedModules + "]";
	}
